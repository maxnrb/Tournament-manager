 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Tournament Manager');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Tournament Manager');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Tournament Manager PDF');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Tournament Manager");
