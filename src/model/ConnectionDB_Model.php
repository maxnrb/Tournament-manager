...
class ConnectionDB_Model extends DB_Info {
    private $connection;
    ...
    public function getAllById($tableName, $idName, $id) {
        $query = $this->getConnection()->prepare("SELECT * FROM $tableName WHERE $idName='$id'");
        $query->execute();
